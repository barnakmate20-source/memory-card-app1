...
questions_list.append( Question("В каком году открыли америку","1492","1392","1694","1322"))
questions_list.append( Question("Каково цвета трава","Жёлтый","Белый","Чорный","Зелёный"))
...
def check_answer():
    ...
    if answers[0].isChecked():                # Перша кнопка — правильна (після shuffle)
        ...
        print("Бали",window.score, "Пройшли запитань", window.total)
